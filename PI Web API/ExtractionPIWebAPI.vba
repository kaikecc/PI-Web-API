...
While exit_hierarchy
   ...
   If attribute_mode = True Then
    ...
    If Items(aux_branch)("HasChildren") = True Then ' Into in each first node of the tree
    ...
    ElseIf Items(aux_branch)("HasChildren") = False And count_node > 1 Then
